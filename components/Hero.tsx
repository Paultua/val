...
export default function Hero() {
  ...
  return (
    <section id="accueil" className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-gradient-to-br from-green-50 via-white to-amber-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-semibold text-gray-900 mb-6 leading-tight">
            Votre bien est loué ?<br />
            Vendez le au meilleur prix
          </h1>
          <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto mb-8">
            Expert de la vente occupée en <strong>Bretagne</strong> et <strong>Paris</strong>. Estimation gratuite sous 24h.
          </p>
