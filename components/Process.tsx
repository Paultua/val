...
export default function Process() {
  ...
  return (
    <section id="comment-ca-marche" className="py-20 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-gray-900 mb-6">
            Vendre votre bien loué{' '}
            <span className="text-primary">en 4 étapes</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Un processus clair pour la vente de votre appartement, maison ou commerce loué
          </p>
        </div>
