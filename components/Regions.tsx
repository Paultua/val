  ...
  const regions = [
    {
      ...
      priority: true,
      description:
        "Notre zone de prédilection. Expertise approfondie de la vente d'appartements loués, maisons louées et commerces loués en Bretagne. Présence active à Vannes, Rennes, Nantes, Lorient, Brest, Saint-Malo, Quimper et Pontivy. Connaissance fine du marché immobilier locatif breton.",
      highlights: [
    ...
    },
    {
      ...
      priority: false,
      description:
        'Expertise du marché parisien et de sa première couronne. Accompagnement sur-mesure pour la vente de biens immobiliers loués dans la capitale et ses environs immédiats.',
      highlights: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-gray-900 mb-6">
            Où nous intervenons : <span className="text-primary">Rennes, Nantes, Vannes, Lorient, Brest</span>{' '}
            et <span className="text-primary">Paris</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Deux régions stratégiques pour vendre votre bien loué
          </p>
        </div>
