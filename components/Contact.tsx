...
export default function Contact() {
  ...
  const offices = [
    ...
    {
      name: 'Île-de-France',
      address: 'Paris et première couronne, via notre réseau',
      phone: '07.63.64.88.23',
      email: 'contact@ukan-group.com',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-gray-900 mb-6">
            Contactez-nous pour vendre votre bien loué
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-10">
            Estimation gratuite pour votre appartement, maison ou commerce loué
          </p>
